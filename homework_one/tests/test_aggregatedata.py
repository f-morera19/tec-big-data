...
def test_aggregateByCyclist_NullValuesForACyclist(spark_session):

    union_data = [
        (508411730, 'Chrystel Horribine', 'San Jose', None, None, None, None),
        (670106829, 'Jeddy Tardiff', 'Heredia', 1, 'Bike Park RIO PERDIDO', 281.5, datetime.date(2021,1,10))]
...
def test_aggregateByRoute_NullValuesForARoute(spark_session):
...
def test_aggregateByProvince_NullValuesForAProvince(spark_session):

    union_data = [
        (508411730, 'Chrystel Horribine', 'San Jose', 2, 'Bike Adventure Park', 222.74, datetime.date(2020,5,8)),
        (508411730, 'Chrystel Horribine', 'San Jose', 1, 'Bike Park RIO PERDIDO', 309.5, datetime.date(2020,5,9)),
        (670106829, 'Jeddy Tardiff', 'Heredia', None, None, None, None)]
...
def test_aggregateByDate_NullValuesForDate(spark_session):

    union_data = [
        (508411730, 'Chrystel Horribine', 'San Jose', 2, 'Bike Adventure Park', 100.74, datetime.date(2020,5,9)),
        (508411730, 'Chrystel Horribine', 'San Jose', 1, 'Bike Park RIO PERDIDO', 123.5, datetime.date(2021,1,10)),
        (670106829, 'Jeddy Tardiff', 'Heredia', None, None, None, None)]
    ...
    # Expected result.
    expected_df = spark_session.createDataFrame([
        (datetime.date(2020,5,9), 100.74),
        (datetime.date(2021,1,10), 123.5)],
        sum_schema_date)
